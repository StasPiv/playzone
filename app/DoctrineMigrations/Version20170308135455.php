 ...
 */
class Version20170308135455 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE game_move CHANGE game_id game_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE game_move CHANGE game_id game_id INT NOT NULL');
    }
}
