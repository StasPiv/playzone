...
WHERE delay > 0 AND IF(gm.user_id = id_white, g.result_white, g.result_black) <> 0 AND gm.time_move < DATE_ADD(CURDATE(), INTERVAL 1 DAY) AND gm.time_move >= DATE_SUB(CURDATE(), INTERVAL 2 DAY)
